...
<div class="col-md-10">
<a href="mailto:soyonancy@gmail.com" style="color:#000000">soyonancy@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nancy soyo</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+27 6165063741</h4>
		<h4 style="font-family:'typo' ">soyonancy@gmail.com</h4>
